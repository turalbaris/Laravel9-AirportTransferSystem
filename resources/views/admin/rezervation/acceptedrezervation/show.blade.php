...
@section('title', 'Accepted Rezervation')
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <form role="form" action="{{route('admin.rezervation.acceptedrezervation.update',['id'=>$data->id])}}" method="post">
                                    @csrf
                                    <tr>
                                        <th>Admin Note</th>
                                        <td>
                                ...
                                <a href="{{route('admin.rezervation.acceptedrezervation.index')}}" class="btn btn-lg btn-danger">Go Back</a>
                            </div>
                        </div>
                    </div>
                </div>
